function [X, fX, dfX, i, RG] = minimize_mod_crit_NKN(X, f, length, crit, varargin)
...
% Lawless/Nichols criterion
rel_grad = 1;  RG = rel_grad;
while  i < abs(length) && rel_grad >= crit   % while not finished and criterion not reached
