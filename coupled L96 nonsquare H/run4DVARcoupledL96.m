...
for ii = 1:1
    ...
    standalone = 2; % 1 for standalone weakly coupled 4d-var, 2 for standalone 4d-var smoother
    ...
    for update_method = 1:2
        ...
        if save_all_figures == 1
            dirname = strcat('C:\results\DA\21Feb2023\a',num2str(space_skip_a),'o',num2str(space_skip_o),'-balanced\');
            mkdir(dirname);
