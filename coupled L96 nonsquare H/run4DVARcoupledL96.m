...
for ii = 1:1
    ...
    dirname = strcat('C:\results\DA\20022023\a',num2str(space_skip_a),'o',num2str(space_skip_o),'-largeR\');
    mkdir(dirname);
    filename1 = strcat(dirname,'plot1a',num2str(ii),'.fig');
    filename2 = strcat(dirname,'plot1b',num2str(ii),'.fig');
    end
    nsteps = 4;
    h=0.0125d0;
    Fx=15;
    ...
    for i_trial = 1:compare_or_standalone
