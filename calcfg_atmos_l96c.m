function [f,g] = calcfg_atom_l96c(dX0_a,u_b,innov,u_lin,H,invB,invR,nsteps,h,na,no,Fx,Fy,alph,gamma,ob_ix)
...
g_hat(1:na,nsteps+1) = g_hat(1:na,nsteps+1) - invR*(ob_ix(1:na,nsteps).*(innov(1:na,nsteps)-H(1:na,1:na)*dz(1:na,nsteps+1)));
...
%     Jacob1_adj = blkdiag(Jacob1(1:na,1:na,i),Jacob1(na+1:end,na+1:end,i));
%     Jacob2_adj = blkdiag(Jacob2(1:na,1:na,i),Jacob2(na+1:end,na+1:end,i));    
